        ...
        return (
            <div style={{
                ...
                {props.listaCandidatos.map((candidato) => (
                    <Candidato key={candidato.id} candidato={candidato} setExibirPropostas={props.setExibirPropostas} proposta={props.proposta} setProposta={props.setProposta} listaCandidatos={listaCandidatos}/>
                ))}
            </div>
        )
    }
