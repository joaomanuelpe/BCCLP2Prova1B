    ...
    return (
        <Card style={{ width: '18rem' }}>
            ...
            <Card.Body>
                ...
                <Button onClick={handleNaoCurtir} variant="primary">
                ...
                <Button className="mt-1" variant="success" onClick={() => showProposals(props.candidato)}>
